...
void setup(){
  ...
  Button sunB = new Button(100,330,60,20);
  sunB.setText("Sun");
  buttons.add(sunB);
  
  Button mercuryB = new Button(100,360,60,20);
  mercuryB.setText("Mercury");
  buttons.add(mercuryB);
  
  Button venusB = new Button(100,390,60,20);
  venusB.setText("Venus");
  buttons.add(venusB);
  
  Button earthB = new Button(100,420,60,20);
  earthB.setText("Earth");
  buttons.add(earthB);
  
  Button marsB = new Button(100,450,60,20);
  marsB.setText("Mars");
  buttons.add(marsB);
  
  Button jupiterB = new Button(100,480,60,20);
  jupiterB.setText("Jupiter");
  buttons.add(jupiterB);
  
  Button saturnB = new Button(100,510,60,20);
  saturnB.setText("Saturn");
  buttons.add(saturnB);
  
  Button uranusB = new Button(100,540,60,20);
  uranusB.setText("Uranus");
  buttons.add(uranusB);
